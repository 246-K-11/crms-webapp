...
function GetAllVehicles() {
  ...
  useEffect(() => {
    fetch("http://localhost/api/vehicles/all.php")
      ...
      /*theVehicles takes on the value of response.json and function setAllVehicless appends each record, from the records key of the json, to allVehicles */
  ...
  return (
    <main>
      ...
      <div className="bg-white px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          {allVehicles.map((vehicleInfo: any) => (
            <li
              key={vehicleInfo.VID}
