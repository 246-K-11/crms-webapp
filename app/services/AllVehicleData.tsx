...
function GetAllVehicles() {
  ...
  function searchVehicle(e: any) {
    ...
    const filtered = allVehicles.filter((vehicle: any) => {
      return vehicle.Model.toLowerCase().includes(value.toLowerCase()) || vehicle.Make.toLowerCase().includes(value.toLowerCase());
  ...
  return (
    <main>
      ...
      <div>
        ...
        <span>Your choice: {carSelected}</span>
        <ul
          role="list"
          ...
          {filteredVehicles.map((vehicleInfo: any) => (
            ...
            >
              <div className="p-4">
                ...
                <button id={vehicleInfo.VID} onClick={selectCar}>Select</button>
              </div>
            </li>
          )
          )}
